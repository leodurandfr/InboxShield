...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "default_category_action", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "updated_at",
            sa.DateTime(timezone=True),
    ...
    op.create_index(
        ...
        "email_threads",
        ["awaiting_reply", "awaiting_response"],
        unique=False,
    ...
    op.create_index(
        "idx_actions_account_date", "actions", ["account_id", "created_at"], unique=False
    )
    ...
    op.create_index(
        "idx_activity_account_date", "activity_logs", ["account_id", "created_at"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "idx_emails_not_archived", table_name="emails", postgresql_where="is_archived = FALSE"
    )
